...
export default function CartPage({
  ...
  //สินค้าแนะนำ
  let recommendations = mockProducts.filter(
    (p) => p.id === 102 || p.id === 105
  );
  ...
  useEffect(() => {
    // แก้ไข: เช็คจาก stock <= 0 แทน status
  ...
  const isAllSelected =
    availableItemsCount > 0 && selectedIds.length === availableItemsCount;
    ...
    <div className="cart-page-container">
      <div className="cart-layout">
        <div className="cart-list-container">
          ...
          {cartItems.map((item) => {
            // แก้ไข: เปลี่ยนเงื่อนไขเช็คสินค้าหมดให้ตรงกับ Class Diagram (stock)
            ...
            return (
              <div
                key={item.id}
                className={`cart-item-group ${isOutOfStock ? 'group-out-of-stock' : ''}`}
              >
                <div className="cart-item-row">
                  ...
                  <div className="col-price">
                    ...
                    >
                      ...
                      {isOutOfStock && (
                        <span className="stock-warning">สินค้าหมดชั่วคราว</span>
                      )}
                    </div>
                  </div>
                  <div className="col-qty">
                    <div
                      className={`qty-simple ${isOutOfStock ? 'hidden-qty' : ''}`}
                    >
                      <button
                        className="qty-btn"
                        ...
                        <div key={rec.id} className="rec-card">
                          ...
                          <div className="rec-price-col">
                            <span className="rec-price">
                              {Number(rec.price).toLocaleString('en-US', {
                                minimumFractionDigits: 2,
                              })}{' '}
                              Baht
                            </span>
